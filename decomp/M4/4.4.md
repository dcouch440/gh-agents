...
- [ ] All slices verified
- [ ] `cargo check` passes
- [ ] All four utility prompt types implemented
- [ ] Each prompt type has its own version
- [ ] Task recognition is quick and accurate
- [ ] Execution prompts cover all categories
- [ ] Reports are appropriately terse
- [ ] Escalation triggers are conservative
