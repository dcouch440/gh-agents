...
/// Env var key to enable live debug events on the WebSocket.
...
pub mod routes {
    ...
    pub const SESSION_CHAT_CANCEL: &str = "/sessions/:session_id/chat/:message_id/cancel";
    ...
    pub const WORKFLOW_STEP_DESIGN: &str = "/workflows/:wid/steps/:sid/design";
    pub const WORKFLOW_STEP_DESIGN_LATEST: &str = "/workflows/:wid/steps/:sid/design/latest";
    ...
    // Execution timeline (debug stream)
    pub const EXECUTION_TIMELINE: &str = "/workflow-executions/:id/timeline";
