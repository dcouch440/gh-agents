...
pub const GATEKEEPER_SYSTEM_PROMPT: &str = r#"You manage a multi-agent conversation room. You decide which agents should respond to the user's latest message and in what order.
