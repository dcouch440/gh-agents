...
#[openapi(
    ...
    tags(
        ...
        (name = "Pipeline Stage Members", description = "Workflows assigned to pipeline stages"),
        (name = "Pipeline Runs", description = "Pipeline execution instances"),
        (name = "Execution Tree", description = "Full execution tree for pipeline runs"),
    ...
    paths(
        ...
        super::api::auth_setup,
        super::api::auth_login,
        super::api::auth_register,
        super::api::auth_me,
        // Tasks
        ...
        super::api::get_agent,
        super::api::update_agent,
        super::api::delete_agent,
        // Tools
        super::api::list_tools,
        super::api::create_tool,
        super::api::get_tool,
        super::api::update_tool,
        super::api::delete_tool,
        super::api::get_agent_tools,
        super::api::set_agent_tools,
        // Agent Context
        ...
        super::api::list_stage_members,
        super::api::add_stage_member,
        super::api::update_stage_member,
        super::api::delete_stage_member,
        // Pipeline Runs
        super::api::render_pipeline_stage,
        super::api::list_pipeline_runs,
        super::api::get_pipeline_run,
        super::api::approve_pipeline_run,
        // Execution Tree
        super::api::get_pipeline_run_tree,
        // Agent Executions
    ...
    components(schemas(
        ...
        super::api::CreateToolRequest,
        super::api::UpdateToolRequest,
        super::api::SetAgentToolsRequest,
        super::api::AgentToolsResponse,
        ...
        super::api::SetupRequest,
        super::api::SetupResponse,
        super::api::RegisterRequest,
        super::api::AuthTokenResponse,
        super::api::UserResponse,
        super::api::LoginRequest,
        super::api::LoginResponse,
        super::api::MeResponse,
        ...
        super::api::StageMemberResponse,
        super::api::CreateStageMemberRequest,
        super::api::UpdateStageMemberRequest,
        ...
        super::api::TreeRunInfo,
        super::api::TreeStage,
        super::api::TreeStageExecution,
        super::api::TreeAgentExecution,
        super::api::TreeResponse,
        ...
        super::api::RenderStageRequest,
        super::api::ApproveRunRequest,
        super::api::PipelineRunResponse,
        super::api::StageExecutionResponse,
        super::api::PipelineRunDetailResponse,
        super::api::ListRunsQuery,
