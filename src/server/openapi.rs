...
#[openapi(
    ...
    paths(
        ...
        // Workflows
        super::api::workflows::workflow_handlers::list_workflows,
        super::api::workflows::workflow_handlers::create_workflow,
        super::api::workflows::workflow_handlers::get_workflow,
        super::api::workflows::workflow_handlers::update_workflow,
        super::api::workflows::workflow_handlers::delete_workflow,
        // Workflow Steps
        super::api::workflows::step_handlers::create_workflow_step,
        super::api::workflows::step_handlers::list_workflow_steps,
        super::api::workflows::step_handlers::get_workflow_step,
        super::api::workflows::step_handlers::update_workflow_step,
        super::api::workflows::step_handlers::delete_workflow_step,
        // Workflow Edges
        super::api::workflows::edge_handlers::list_workflow_edges,
        super::api::workflows::edge_handlers::add_workflow_edge,
        super::api::workflows::edge_handlers::remove_workflow_edge,
        // Step Documents
        super::api::workflows::document_handlers::list_step_documents,
        super::api::workflows::document_handlers::add_step_document,
        super::api::workflows::document_handlers::remove_step_document,
        // Agent Executions
