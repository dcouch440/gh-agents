...
describe('ReviewCard', () => {
  it('renders execution input text', () => {
    render(<ReviewCard execution={mockAgentExecution} selected={false} onSelect={vi.fn()} />)
  ...
  it('calls onSelect with execution id when clicked', async () => {
    ...
    const { container } = render(<ReviewCard execution={mockAgentExecution} selected={false} onSelect={onSelect} />)
  ...
  it('renders without error when selected', () => {
    const { container } = render(<ReviewCard execution={mockAgentExecution} selected={true} onSelect={vi.fn()} />)
