type DocumentNodeIconProps = {
  color?: string
  size?: number
}

function DocumentNodeIcon({ color = '#10b981', size = 24 }: DocumentNodeIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export { DocumentNodeIcon }
export type { DocumentNodeIconProps }
