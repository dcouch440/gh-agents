...
function PropertiesPanel() {
  const selectedStepIds = useStore(
    canvasStore.store,
    canvasStore.selectSelectedStepIds,
  );
  const selectedEdgeIds = useStore(
    canvasStore.store,
    canvasStore.selectSelectedEdgeIds,
  );
  ...
  const selectedStep = useStore(
    workflowStore.store,
    workflowStore.selectStepById(firstStepId),
  );
  ...
  const selectedEdge = useStore(
    workflowStore.store,
    workflowStore.selectEdgeById(firstEdgeId),
  );
