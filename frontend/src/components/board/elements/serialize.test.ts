...
describe('serializeToExcalidraw', () => {
  ...
  it('rectangle boundElements includes connected arrow refs', () => {
    ...
    const arrow = createArrow(box1.id, box2.id, { side: 'right', ratio: 0.5 }, { side: 'left', ratio: 0.5 })
...
describe('serialize → deserialize round-trip', () => {
  ...
  it('preserves multiple boxes and arrows', () => {
    ...
    const arrow1 = createArrow(box1.id, box2.id, { side: 'right', ratio: 0.5 }, { side: 'left', ratio: 0.5 })
    const arrow2 = createArrow(box2.id, box3.id, { side: 'bottom', ratio: 0.5 }, { side: 'top', ratio: 0.5 })
