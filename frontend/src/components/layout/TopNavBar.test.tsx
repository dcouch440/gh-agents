...
describe('TopNavBar', () => {
  it('renders nav items', () => {
    const items = [makeItem({ key: '/a', label: 'Alpha' }), makeItem({ key: '/b', label: 'Beta' })]
  ...
  it('renders utility items', () => {
    ...
    const utility = [makeItem({ key: '/settings', label: 'Settings', icon: createElement(SettingsOutlined, { fontSize: 'small' }) })]
  ...
  it('renders trailing content', () => {
    render(<TopNavBar navItems={[]} utilityItems={[]} trailing={<button data-testid="trailing">Theme</button>} />)
