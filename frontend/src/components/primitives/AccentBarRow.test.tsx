...
describe('AccentBarRow', () => {
  it('renders primary and secondary text', () => {
    render(<AccentBarRow barColor="#3b82f6" primary="Frontend Dev" secondary="frontend" />)
  ...
  it('renders actions when provided', () => {
    render(<AccentBarRow barColor="#3b82f6" primary="Test" actions={<button type="button">Edit</button>} />)
  ...
  it('calls onClick when clicked', async () => {
    ...
    const onClick = vi.fn()
    render(<AccentBarRow barColor="#3b82f6" primary="Clickable" onClick={onClick} />)
