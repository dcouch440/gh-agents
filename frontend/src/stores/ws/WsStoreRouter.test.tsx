...
const mockUnsubs = vi.hoisted(() => Array.from({ length: 8 }, () => vi.fn()))
...
describe('WsStoreRouter', () => {
  ...
  it('subscribes to all topics for domain stores + flight recorder (8 total)', () => {
  ...
  it('unsubscribes all 8 handlers on unmount', () => {
