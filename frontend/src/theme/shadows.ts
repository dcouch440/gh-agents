...
const lightShadows: Shadows = [
  ...
  '0 2px 4px rgba(61, 43, 31, 0.05)',
  '0 2px 6px rgba(61, 43, 31, 0.06)',
  '0 3px 8px rgba(61, 43, 31, 0.06)',
  '0 4px 10px rgba(61, 43, 31, 0.07)',
  '0 4px 12px rgba(61, 43, 31, 0.07)',
  '0 6px 14px rgba(61, 43, 31, 0.08)',
  '0 6px 16px rgba(61, 43, 31, 0.08)',
  '0 8px 18px rgba(61, 43, 31, 0.08)',
  '0 8px 20px rgba(61, 43, 31, 0.09)',
  '0 10px 22px rgba(61, 43, 31, 0.09)',
  '0 10px 24px rgba(61, 43, 31, 0.09)',
  '0 12px 26px rgba(61, 43, 31, 0.10)',
  '0 12px 28px rgba(61, 43, 31, 0.10)',
  '0 14px 30px rgba(61, 43, 31, 0.11)',
  '0 14px 32px rgba(61, 43, 31, 0.11)',
