...
const midnightPalette: PaletteOptions = {
  ...
  background: { default: '#080c12', paper: '#111318' },
  text: { primary: '#f0f6fc', secondary: '#7d8590', disabled: '#484f58' },
...
const slatePalette: PaletteOptions = {
  ...
  background: { default: '#1e2433', paper: '#252b3b' },
...
const slateCustom: CustomTokens = {
  ...
  separatorSubtle: 'rgba(226, 232, 240, 0.04)',
  activeTint: 'rgba(129, 140, 248, 0.06)',
  activeTintStrong: 'rgba(129, 140, 248, 0.10)',
  ...
  minimapBg: 'rgba(30, 36, 51, 0.9)',
  minimapMask: 'rgba(26, 31, 46, 0.7)',
  floatingPanelBg: 'rgba(34, 40, 57, 0.95)',
  floatingPanelBorder: 'rgba(226, 232, 240, 0.10)',
  chromeText: '#94a3b8',
  chromeTextActive: '#818cf8',
  chromeTextHover: '#e2e8f0',
  chromeActiveGlow: 'drop-shadow(0 0 4px rgba(129, 140, 248, 0.4))',
  chromeActiveBar: '#818cf8',
  screenBg: '#1e2433',
  screenBorder: 'rgba(226, 232, 240, 0.10)',
  screenFrost: 'rgba(30, 36, 51, 0.8)',
  canvasBg: '#1a1f2e',
  accent: '#818cf8',
  accentBg: 'rgba(129, 140, 248, 0.08)',
  accentRing: 'rgba(129, 140, 248, 0.20)',
  userBarBg: 'rgba(129, 140, 248, 0.06)',
