...
ADD COLUMN sub_workflow_template_id UUID REFERENCES run_templates(id) ON DELETE SET NULL;

-- Track parent-child execution hierarchy for nested workflows.
ALTER TABLE workflow_executions
ADD COLUMN parent_execution_id UUID REFERENCES workflow_executions(id) ON DELETE SET NULL;
